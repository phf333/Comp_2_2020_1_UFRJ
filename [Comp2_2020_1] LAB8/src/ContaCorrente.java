...
public class ContaCorrente {
    ...
    public void depositar(float valor) throws DepositoNaoPositivoException {
        // valida o parâmetro
        if (valor <= 0) {
            throw new DepositoNaoPositivoException();
        }
     ...
     */
    public void transferir(float valor, ContaCorrente contaDestino) throws ValorDeTranferenciaNaoPositivoException,
            SaldoInsuficienteException{
        // valida o parâmetro
        if (valor <= 0) {
            throw new ValorDeTranferenciaNaoPositivoException();
        }
