...
public class InterfaceTexto {
    ...
    public static void main(String[] args) {
        ...
        Pacotinho p5 = new Pacotinho(album, new int[] {1, 6, 18});

        ArrayList<Figurinha> teste = new ArrayList<>();

        Pacotinho p7 = new Pacotinho(album);
        album.receberNovoPacotinho(p5);
        album.receberNovoPacotinho(p1);

        //System.out.println(p7);
        System.out.println(album);
        System.out.println(album.getQuantFigurinhasColadas());
        System.out.println(album.getQuantFigurinhasRepetidas());
